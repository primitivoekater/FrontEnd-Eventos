...
3 Exercicios para a criação de eventos. Os eventos são utilizados  quando varias interatividades unicas são encadeadas umas nas outras, como  um botão que , ao ser clicado leva a alguma outra página.
